...
function b4st_enqueues() {
	...
	wp_register_style('bootstrap-css', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha.5/css/bootstrap.min.css', false, '4.0.0.alpha5', null);
	...
	wp_enqueue_script('modernizr');
  	...
  	wp_register_script('bootstrap-js', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha.5/js/bootstrap.min.js', false, '4.0.0.alpha5', true);
